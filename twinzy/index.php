...
<body>
	...
	<section id="hero-section" style="position: relative; height: 100vh; overflow: hidden;">
		<video autoplay muted loop playsinline
			...
			<source src="../assets/Twinzy.mp4" type="video/mp4">
		</video>
		<div class="hero-content">
			<h1>Twinzy Home Care<br>Freshness Reimagined</h1>
			<span class="sub-text">Premium home care products aimed at revitalizing your living spaces and preserving
				your furniture's beauty</span>
	...
	<section class="products-showcase">
		<h2>Our Twinzy Collection</h2>
		<p class="section-subtitle">Discover our complete range of Air Freshners and Furniture Polish</p>
  ...
  `;
	...
	<script src="../assets/twinzy-logic.js"></script>
	<script>
	...
	<script type="module">
		...
		if (!container) {
			...
			const uniforms = {
				...
				uMouse: { value: new THREE.Vector2(0.5, 1) },
			};
	...
	<script type="module">
		...
		`;
			...
			const onHeroMouseMove = (e) => {
				...
				heroUniforms.uMouse.value.y = 1 - ny;
			};
